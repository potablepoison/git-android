...
public class MainActivity extends Activity {
	WorldGen earth = new WorldGen("Earth", 5973, 9.78);   //Create world object
    ...
    protected void setStartUpWorldValues() {
    	earth.setPlanetColonies(1);               // Set Planet Colonies
        earth.setPlanetMilitary(1);              // Set Planet Military Bases
